...
#define BBOX_FILE "../data/speed_tracking_v3/bbox_files/car_h40.txt"
#define RAW_FRAMES_LOCATION "../data/speed_tracking_v3/frames/1_raw/h40"
#define PROCESSED_FRAMES_LOCATION "../data/speed_tracking_v3/frames/2_yolo/h40"
#define COUNTED_FRAMES_LOCATION "../data/speed_tracking_v3/frames/3_processed/h40"

#define LOG_FILE_NAME "../data/speed_tracking_v3/logs/car_40.txt"
			...
			// {
				...
				if( !prevgray.empty() )
				{
					...
					if (f-START_FRAME > 5)
					{
						...
						putText(image_processed, to_string(depth), cvPoint(10, 30), FONT_HERSHEY_SIMPLEX, 1, cvScalar(0, 0, 255), 2, CV_AA);
